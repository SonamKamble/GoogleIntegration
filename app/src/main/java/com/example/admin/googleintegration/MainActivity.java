package com.example.admin.googleintegration;
    ...
    */
    ...
    public void onConnectionFailed(ConnectionResult result) {
        if (!result.hasResolution()) {
            GoogleApiAvailability.getInstance().getErrorDialog(this, result.getErrorCode(), request_code).show();
            return;
        }
    ...
    private void setPersonalInfo(Person currentPerson) {
       String personPhotoUrl = currentPerson.getImage().getUrl();
        TextView user_name = (TextView) findViewById(R.id.TVUsername);
        user_name.setText(currentPerson.getDisplayName());
        String email = Plus.AccountApi.getAccountName(google_api_client);
        TextView mail_id = (TextView) findViewById(R.id.TVEmail);
